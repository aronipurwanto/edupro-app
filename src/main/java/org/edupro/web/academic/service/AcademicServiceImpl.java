...
public class AcademicServiceImpl extends BaseService implements AcademicService {
    ...
    public List<AcademicYearRes> get() {
        try {
            ...
            if (response.getStatusCode() == HttpStatus.OK) {
                return (List<AcademicYearRes>) response.getBody().getData();
            }
    ...
    public Optional<AcademicYearRes> getById(String id) {
        try {
            ...
            if (response.getStatusCode() == HttpStatus.OK) {
                ...
                AcademicYearRes result = objectMapper.readValue(json, AcademicYearRes.class);
    ...
    public Optional<AcademicYearRes> save(AcademicYearReq request) {
        try {
            var url = backEndUrl.tahunAjaranUrl();
            HttpEntity<AcademicYearReq> httpEntity = new HttpEntity<>(request, getHeader());
